...
// 	protoc        v6.32.0
// source: proto/mexc/response.proto
...
func (x *PublicMiniTickerV3Api) Reset() {
	*x = PublicMiniTickerV3Api{}
	mi := &file_proto_mexc_response_proto_msgTypes[0]
...
func (*PublicMiniTickerV3Api) Descriptor() ([]byte, []int) {
	return file_proto_mexc_response_proto_rawDescGZIP(), []int{0}
}
...
var File_proto_mexc_response_proto protoreflect.FileDescriptor

const file_proto_mexc_response_proto_rawDesc = "" +
	"\n" +
	"\x19proto/mexc/response.proto\"\xf1\x02\n" +
	...
	"\flastCloseLow\x18\f \x01(\tR\flastCloseLowBt\n" +
	"\x1ccom.mxc.push.common.protobufB\x1aPublicMiniTickerV3ApiProtoH\x01P\x01Z4github.com/skip-mev/slinky/providers/websockets/mexcb\x06proto3"

var (
	file_proto_mexc_response_proto_rawDescOnce sync.Once
	file_proto_mexc_response_proto_rawDescData []byte
)

func file_proto_mexc_response_proto_rawDescGZIP() []byte {
	file_proto_mexc_response_proto_rawDescOnce.Do(func() {
		file_proto_mexc_response_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_mexc_response_proto_rawDesc), len(file_proto_mexc_response_proto_rawDesc)))
	})
	return file_proto_mexc_response_proto_rawDescData
}

var file_proto_mexc_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_mexc_response_proto_goTypes = []any{
	(*PublicMiniTickerV3Api)(nil), // 0: PublicMiniTickerV3Api
}
var file_proto_mexc_response_proto_depIdxs = []int32{
...
func init() { file_proto_mexc_response_proto_init() }
func file_proto_mexc_response_proto_init() {
	if File_proto_mexc_response_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_mexc_response_proto_rawDesc), len(file_proto_mexc_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_mexc_response_proto_goTypes,
		DependencyIndexes: file_proto_mexc_response_proto_depIdxs,
		MessageInfos:      file_proto_mexc_response_proto_msgTypes,
	}.Build()
	File_proto_mexc_response_proto = out.File
	file_proto_mexc_response_proto_goTypes = nil
	file_proto_mexc_response_proto_depIdxs = nil
}
